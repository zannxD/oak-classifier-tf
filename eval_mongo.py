...
tf.flags.DEFINE_string("checkpoint_dir", "runs/1506238124/checkpoints/", "Checkpoint directory from training run")
...
for m in movies.find():
    ...
    #        x_raw = ["i want to buy movie tickets", "tickets out yet?"]
        x_raw = m["comments"]
        print("\n-----------------------------------------------------------------------------------------")
        y_test = None
...
#    print("VALUE:   ",predictions_human_readable[[1]])
